internal static class MsFormsControlSchemaCatalog
{
    ...
    [
        ...
        new("ComboBox", "2.2.5", "msOFormsMorphData", "0x0000000080050141", "0x00000035", "0x2C80481B", "0x00000013", "MorphDataDataBlock, MorphDataExtraDataBlock, MorphDataStreamData, TextProps, optional ColumnInfo", FactoryStatus.PendingFactory),
        new("ListBox", "2.2.5", "msOFormsMorphData", "0x0000000080010160", "0x00000035", null, "0x00000013", "MorphDataDataBlock, MorphDataExtraDataBlock, MorphDataStreamData, TextProps, optional ColumnInfo", FactoryStatus.PendingFactory),
        ...
        new("Image", "2.2.3", "msOFormsImage", "0x00000600", null, null, "0x00000013", "ImageDataBlock, ImageExtraDataBlock, ImageStreamData", FactoryStatus.PendingFactory),
        new("ScrollBar", "2.2.7", "msOFormsScrollBar", "0x00002008", null, null, "0x00000013", "ScrollBarDataBlock, ScrollBarExtraDataBlock, ScrollBarStreamData", FactoryStatus.PendingFactory),
        new("SpinButton", "2.2.8", "msOFormsSpinButton", "0x00000808", null, null, "0x00000013", "SpinButtonDataBlock, SpinButtonExtraDataBlock, SpinButtonStreamData", FactoryStatus.PendingFactory),
        new("TabStrip", "2.2.9", "msOFormsTabStrip", "0x00FA8031", "0x00000035", null, "0x00000013", "TabStripDataBlock, TabStripExtraDataBlock, TabStripStreamData, TextProps, TabStripTabFlagData", FactoryStatus.PendingFactory),
        new("Frame", "2.2.10", "msOFormsFormSiteData", null, null, null, "0x00040023", "Storage-backed FormControl/FormSiteData plus parent object metadata", FactoryStatus.PendingStorageFactory),
